---
url: https://docs.sysreptor.com/reporting/ai-agent.md
---
# AI Agent
...
* **Agent** (): Full write access in this project. In addition to everything in Ask mode, the agent can create findings and notes and update section, finding, and note fields.
